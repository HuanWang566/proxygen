...
const int AGV_CAR_NUMBER = 2;
const int ROBOT_ARM_NUMBER = 3;
const int CONVEYOR_NUMBER = 1;

// const std::string SERIAL_PORT_NAME = "/dev/ttyS5";
const std::string SERIAL_PORT_NAME = "/dev/pts/0";
